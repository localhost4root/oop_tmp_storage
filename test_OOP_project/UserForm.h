...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->проДодатокToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {
				this->розробникиToolStripMenuItem,
					this->bagBountyToolStripMenuItem
			});
			...
			this->розробникиToolStripMenuItem->Size = System::Drawing::Size(180, 22);
			...
			this->bagBountyToolStripMenuItem->Size = System::Drawing::Size(180, 22);
